...
[o] BMI 계산 로직 TC
[o] Age 평균치 보정 로직 TC
[o] 정상/저체중/과체중/비만 분류 TC
[o] 예외상황 TC
4. 기능 개선 (2시간)
[o] SRP에 따른 책임 분리등 리팩토링 
[o] 특정 연령대의 BMI 분포 비율 계산 기능 추가
[o] Height가 0인 경우에 대한 평균치 보정 로직 추가 
[o] BMI 정상 범위 사용자 목록 조회 기능 추가
[o] 전체 사용자 대비 각 BMI 범주 비율 계산 기능 추가
5. 회고 및 발표 (1시간) 
[] 실습 목표와 달성도 
[] 코드 품질 Before & After
