...
| ID | 테스트명 예시 | 검증 내용 |
|---|---|---|
| UT-P1-001 | `Classify_ReturnsUnderweight_WhenBmiIs18Point5` | BMI `18.5`는 저체중이다. |
| UT-P1-002 | `Classify_ReturnsNormal_WhenBmiIsGreaterThan18Point5AndLessThan23` | BMI `18.5` 초과, `23` 미만은 정상이다. |
| UT-P1-003 | `Classify_ReturnsOverweight_WhenBmiIs23` | BMI `23.0`은 과체중이다. |
| UT-P1-004 | `Classify_ReturnsObesity_WhenBmiIs25` | BMI `25.0`은 비만이다. |
